/**
 * Listrik Topic - Specific Content
 * This file contains all content related to the Listrik topic
 */

const listrikaContent = {
    id: 'listrik',
    title: 'Listrik',
    modulPath: './data/MODUL LISTRIK.pdf',
    videoPath: './assets/videos/VideoListrik.mp4',
    ...
    renderModul() {
        ...
        contentCard.innerHTML = `
            <div style="text-align: center; padding: 2rem;">
                <p>Modul untuk topik Listrik sedang dalam pengembangan. Silakan coba topik lain.</p>
            </div>
        `;
    },
    ...
    renderVideo() {
        ...
        contentCard.innerHTML = `
            <div style="text-align: center; padding: 2rem;">
                <p>Video tutorial untuk topik Listrik sedang dalam pengembangan. Silakan coba topik lain.</p>
            </div>
        `;
    },
