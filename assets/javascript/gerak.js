/**
 * Gerak Lurus Topic - Specific Content
 * This file contains all content related to the Gerak Lurus topic
 */

const gerakContent = {
    id: 'gerak',
    title: 'Gerak Lurus',
    modulPath: './data/MODUL GERAK.pdf', // Update path when file is available
    videoPath: './assets/videos/VideoGerak.mp4', // Update path when file is available
    ...
    renderModul() {
        ...
        contentCard.innerHTML = `
            <div style="text-align: center; padding: 2rem;">
                <p>Modul untuk topik Gerak Lurus sedang dalam pengembangan. Silakan coba topik lain.</p>
            </div>
        `;
    },
    ...
    renderVideo() {
        ...
        contentCard.innerHTML = `
            <div style="text-align: center; padding: 2rem;">
                <p>Video tutorial untuk topik Gerak Lurus sedang dalam pengembangan. Silakan coba topik lain.</p>
            </div>
        `;
    },
